...
namespace SharpInterop.SDL2
{
    public static class SDL_ttf
    {
        ...
        public static unsafe IntPtr TTF_OpenFont(ReadOnlySpan<char> file, int ptsize)
        {
        ...
        {
            byte* buffer1 = stackalloc byte[SDL.StackBufferSize];
            byte* utf8Text = SDL.Utf8EncodeHeap(text, buffer1, SDL.StackBufferSize, out byte* allocation1, out _);
        ...
        public static void TTF_SetError(ReadOnlySpan<char> fmtAndArglist)
        {
